...
Through this feature, users can pre configure field templates, and when creating a new Stream, they can select the already configured field template, thereby achieving the goal of configuring multiple Stream reuse.
