...
|                  名称                 |  版本 |     日期   |                                                                                                                                                                                 Downloads                                                                                                                                                                                          |
|:-------------------------------------:|:-----:|:----------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
|          InLong Source Code           | 1.8.0 | 2023-07-20 |                                     [[SRC](https://archive.apache.org/dist/inlong/1.8.0/apache-inlong-1.8.0-src.tar.gz)]                [[ASC](https://archive.apache.org/dist/inlong/1.8.0/apache-inlong-1.8.0-src.tar.gz.asc)]                [[SHA512](https://archive.apache.org/dist/inlong/1.8.0/apache-inlong-1.8.0-src.tar.gz.sha512)]                                     |
|          InLong Binary File           | 1.8.0 | 2023-07-20 |                                     [[BIN](https://archive.apache.org/dist/inlong/1.8.0/apache-inlong-1.8.0-bin.tar.gz)]                [[ASC](https://archive.apache.org/dist/inlong/1.8.0/apache-inlong-1.8.0-bin.tar.gz.asc)]                [[SHA512](https://archive.apache.org/dist/inlong/1.8.0/apache-inlong-1.8.0-bin.tar.gz.sha512)]                                     |
| Connector Binary File For Flink v1.13 | 1.8.0 | 2023-07-20 | [[BIN](https://archive.apache.org/dist/inlong/1.8.0/apache-inlong-1.8.0-sort-connectors-flink-v1.13.tar.gz)]                [[ASC](https://archive.apache.org/dist/inlong/1.8.0/apache-inlong-1.8.0-sort-connectors-flink-v1.13.tar.gz.asc)]                [[SHA512](https://archive.apache.org/dist/inlong/1.8.0/apache-inlong-1.8.0-sort-connectors-flink-v1.13.tar.gz.sha512)] |
| Connector Binary File For Flink v1.15 | 1.8.0 | 2023-07-20 | [[BIN](https://archive.apache.org/dist/inlong/1.8.0/apache-inlong-1.8.0-sort-connectors-flink-v1.15.tar.gz)]                [[ASC](https://archive.apache.org/dist/inlong/1.8.0/apache-inlong-1.8.0-sort-connectors-flink-v1.15.tar.gz.asc)]                [[SHA512](https://archive.apache.org/dist/inlong/1.8.0/apache-inlong-1.8.0-sort-connectors-flink-v1.15.tar.gz.sha512)] |

### 发布完整性

您必须 [验证](https://www.apache.org/info/verification.html) 下载文件的完整性。
我们为每个发布文件提供 OpenPGP 签名。此签名应与包含 InLong 发布经理的 OpenPGP 密钥的 [KEYS](https://archive.apache.org/dist/inlong/KEYS) 文件匹配。
